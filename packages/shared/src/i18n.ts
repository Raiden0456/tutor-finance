// Shared Russian dictionary — single source of truth for both web and mobile.
// Superset of both clients' strings (0 conflicting values). Extra keys are harmless:
// English mode uses an empty dict and falls back to the key itself.
